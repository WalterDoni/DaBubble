...
@Component({
  selector: 'app-message-from-logged-in-user',
  templateUrl: './message-from-logged-in-user.component.html',
  styleUrls: ['./message-from-logged-in-user.component.scss']
})
export class MessageFromLoggedInUserComponent {
